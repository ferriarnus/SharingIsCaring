package com.ferri.arnus.sharingiscaring.screen;
...
public class GiftScreen extends AbstractContainerScreen<GiftMenu> {
    private static final ResourceLocation HOPPER = new ResourceLocation("textures/gui/container/hopper.png");

    public GiftScreen(GiftMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
